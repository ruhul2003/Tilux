    ...
    useEffect(() => {
        const getData = async () => {
            try {
                ...
                const safeTiles = Array.isArray(data)
                    ? data
                    : data?.tiles || [];
        ...
        <div className="bg-gradient-to-r from-zinc-800 to-gray-700 flex flex-col items-center text-center px-4 md:px-6 pb-20 overflow-hidden relative">
            ...
            <div className="min-h-[70vh] md:min-h-[85vh] text-center flex flex-col justify-center items-center w-full max-w-7xl">
                ...
                <p className="text-base md:text-lg text-gray-300 mt-5 max-w-2xl leading-relaxed">
                    ...
                    processing technology to deliver timeless beauty and
                    strength.
                </p>
                ...
                {!loading && !error && tiles.length > 0 && (
                    <div className="w-screen mt-16 md:mt-24">
                        ...
                        <Marquee
                            ...
                            pauseOnHover={true}
                            gradient={false}
                            className="bg-black/30 backdrop-blur-sm text-white py-4 border-y border-white/5"
                        >
                            <span className="mx-4 font-bold text-[#FFD700]">
                                NEW ARRIVALS:
                            </span>
            ...
            <div className="w-full max-w-7xl px-2">
                ...
                {loading && (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[1, 2, 3, 4].map((n) => (
                            <div
                                key={n}
                                className="h-80 w-full bg-white/5 animate-pulse rounded-2xl"
                            ></div>
                        ))}
                    </div>
                )}
                ...
                {/* Error */}
                {error && (
                    <p className="text-red-400 bg-red-400/10 py-4 px-6 rounded-xl border border-red-400/20">
                        {error}
                    </p>
                )}
                            ...
                            >
                                ...
                                <div className="p-5 flex-grow flex flex-col text-white">
                                    ...
                                    <div className="mt-5 pt-4 border-t border-white/5 flex justify-between items-center">
                                        ...
                                        {/* Stock Status */}
                                        <span
                                            className={`text-[10px] uppercase tracking-widest font-bold px-2 py-1 rounded ${tile.inStock
